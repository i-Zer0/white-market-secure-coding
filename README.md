...
- 거래: 구매자 요청, 판매자 승인·거절, 거래 금액 스냅샷, WM 가상 포인트 송금, 구매자 거래 완료, 안전 체크리스트, 노쇼·사기 의심 신고 연결, 채팅·제안·상태·송금 증빙 이력
...
- WM 포인트는 실제 현금 가치가 없는 교육용 수단이며 가입 시 1,000,000포인트가 지급됩니다. 판매자가 승인한 예약중 거래의 구매자만 확정 거래 금액을 한 번 송금할 수 있으며, 차감·적립·원장 기록은 하나의 DB 트랜잭션으로 처리합니다.
